...
sayHelloButton.addEventListener('mouseout', mouseOffButton)
...
const repeatMyParam = () => {
    axios.get(`http://localhost:3000/repeat/yo`)
    .then(response => {
...
// CODE HERE
function queryBtn () {
    axios.get(`http://localhost:3000/query-test/?age=54`)
    .then(response => {
        console.log(response.data);
    })
}
...
// 1: The answer still gets printed in the console with it saying You sent a query: age with value: !
// With the query gone, it will tell you it sent an empty query.

// 2: You sent more than 1 query! Gets displayed
...
formFood.addEventListener('submit', createFood)